...
<head>
    ...
    <script type="application/ld+json">
      ...
      "offers": {
        ...
        "itemOffered": {
          "@type": "Service",
          "name": "BTL Advertising in Chennai",
          "description": "Chennai's top BTL advertising agency offering bus branding, event activations, in-store promotions, and hyper-local campaigns for measurable brand engagement.",
          "image": {
            "@type": "ImageObject",
            "url": "https://www.baleenmedia.com/assets/images/btl-ad-example.jpg",
            "width": "1200",
            "height": "630",
            "caption": "BTL Advertising Services in Chennai by Baleen Media"
          }
        }
      },
      "description": "Baleen Media is Chennai's leading BTL advertising agency, specializing in creative BTL ads, event activations, bus branding, and targeted below-the-line campaigns."
    }
    </script>
    ...
    <meta name="title" content="Best BTL Advertising Agency in Chennai | BTL Ads & Activities - Baleen Media">
    <meta name="google-site-verification" content="ag4YAzKPy59TOGFFIbjzD8ihGHRgjSAAdz5eV52cJbg" />
    <title>BTL Advertising Agency in Chennai | BTL Ads & Activities - Baleen Media</title>
    <meta name="description"
        content="Baleen Media: Chennai's #1 BTL advertising agency for creative BTL ads, activations, bus branding & campaigns. Affordable below-the-line marketing solutions with measurable ROI.">
    <meta name="keywords"
        content="btl advertising agency in chennai, btl ads, btl activities, below-the-line advertising, btl marketing chennai, best btl agency chennai, btl campaigns, event activations, in-store promotions, outdoor btl ads, affordable btl ads, btl branding chennai">
    ...
    <link rel="canonical" href="https://www.baleenmedia.com/btl-advertising-agency-chennai" />
    <!-- Favicon-->
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Barlow:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Gloria+Hallelujah&family=Raleway:ital,wght@0,100..900;1,100..900&family=SUSE:wght@100..800&display=swap"
        rel="stylesheet">
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Upright:wght@300;400;500;600;700&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap"
        rel="stylesheet">
...
<body data-spy="scroll" data-target="navbar-default" data-offset="50">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P7F32DSR" height="0" width="0"
    ...
    <nav class="navbar navbar-expand-lg navbar-light   mb-0 p-2  rounded-0 sticky-top "
        style=" background-color:#F1EAFF;" id="navbar">
        <div class="container ">
            <a href="https://www.baleenmedia.com" class="custom-logo-link"
                rel="home"><img class="img-fluid custom-logo" src="assets/images/bmwebsitelogo.png" alt="Baleen Media"></a>
                ...
                <ul id="menu-primary" class="navbar-nav ml-auto">
                    ...
                    <li class="menu-item dropdown">
                        ...
                        <div class="dropdown-menu" id="service">
                            <a href="newspaper-advertisement-agency-in-chennai.php" class="dropdown-item ">Newspaper and
                                Magazine Ads</a>
                            ...
                            <a href="digitalmarketing-advertisement-agency-in-chennai.html"
                            ...
                            <a href="paperinsert-advertisement-agency-in-chennai.php" class="dropdown-item ">Paper
                                Insert</a>
                            <a href="noparking-advertisement-agency-in-chennai.php" class="dropdown-item ">NoParking
                                Board</a>
