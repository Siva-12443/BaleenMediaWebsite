<?php
include('include/top_theater.php');
?>
    <!-- breadcrumb -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="breadcrumb-title">
                        <h1>Cinema Theatre Advertisement</h1>
                        <div class="breadcrumbs">
                            <div id="crumbs">
                                <a href="https://www.baleenmedia.com">Services</a> <i>>></i> <span class="active">Theatre Advertisement</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-8">
                    <article class="post">
                        <div class="post_thumbnail">
                            <img src="assets/images/projects/Theatre.jpg" class="img-fluid" alt="Image"> </div>                       
                        <!-- .entry-meta -->

                        <div class="entry-content">                            
                            <blockquote>
                                <p class="justify"><i>
                                    We are the leading service providers for theatre advertisements to our clients and appear at the top of most ad agencies in Chennai. Cinema advertising is a grand way to place your information in front of a settled audience. This is used to spread awareness live in front of the target audience. It is used for faster and active advertisements and is highly recognized by the customers. In addition to this, it is being offered at the best rates in the industry and is running high in demand. We are the best advertising company in Chennai with an excellent advertising strategy. 
It is a sufficient means if you want to dominate your brand. It gets to display at the beginning of the show, in the interval, and also at the end of the movie, this brings more attention of the audience to the ad.<br>
Think Big for better, Use Theatre advertise.
<!--                                    We are the leading service providers for theatre advertisements to our clients. This is used to spread awareness live in front of the target audience. It is used for faster and quick advertisements and is highly appreciated by the customers. In addition to this, it is being offered at the best rates in the industry and is running high in demand.-->
<!--                                We are the leading service providers for theatre advertisements to our clients. Cinema advertising is a grand way to place your information in front of a settled audience. This is used to spread awareness live in front of the target audience. It is used for faster and active advertisements and is highly recognized by the customers. In addition to this, it is being offered at the best rates in the industry and is running high in demand. -->
<!--It is a sufficient means if you want to dominate your brand. It gets to display at the beginning of the show, in the interval, and also at the end of the movie, this brings more attention of the audience to the ad.-->
</i></p>
                            </blockquote>                            
                        </div>
                        <!-- .entry-content -->
