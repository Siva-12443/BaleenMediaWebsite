...
<div class="container">
    <div class="row1">
        <div class="col-md-6">
            <h1>Traffic Alert Advertisement</h1>
            <p>We are here to provide you the best Traffic Alert Advertisement.</p>
        </div>
        <div class="col-md-6">
...
<h2 style="font-size: 40px; font-family:Montserrat;  padding:20px 0px;">Why Traffic Alert Ads?</h2>
...
<br>
<p><span>Get your brand well known and remarkable by Traffic Alert Advertisement.</span></p>
</section>
 <!-- =========================================================================================================================================== -->
